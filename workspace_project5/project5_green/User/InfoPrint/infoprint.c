...
{
    OLED_Clear();
    OLED_ShowString(2, 0, "Task 1", 8);
    OLED_ShowString(2, 1, "Task 2", 8);
    OLED_ShowString(2, 2, "Task 3", 8);
    OLED_ShowString(2, 3, "Task 4", 8);
    OLED_ShowString(2, 4, "Task 5", 8);
    OLED_ShowString(2, 5, "Task 6", 8);
